...
Agentic RAG 软件项目知识助手（面向求职展示）。当前阶段：**P0 可运行基线**，尚未开始编码。
任何执行开发任务的模型/人，开工前按下述顺序读文档，并严格遵守本文件规则。

## 文档地图与优先级（冲突时序号小的赢）

1. `docs/范围冻结与架构决策.md` — 范围、阶段边界、架构决策 D1–D10、已确认决策
...
5. `docs/项目初步规划报告.md` — 仅作愿景与 P2+ 方向参考，已被部分修订，冲突时以 1–4 为准

## 硬规则（违反 = 返工）

- **范围纪律**：只做《P0任务清单》中当前未勾选的任务。清单外的想法/优化写入 `docs/backlog.md`，不得直接实现。不细化 P1/P2/P3。
